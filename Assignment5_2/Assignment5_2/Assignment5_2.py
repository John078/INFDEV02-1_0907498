...
#[a-z] zoekt alles tussen a en z. [^....._] geeft aan alles behalve dat.
length_password = 6 <= len(password) <= 12
lowercase_password = re.search('[a-z]', password)
uppercase_password = re.search('[A-Z]', password)
numbers_password = re.search('[0-9]', password)
special_password = re.search('[^a-zA-Z0-9_]', password)
